// mylab_d3d9.cpp : 定义应用程序的入口点。
//

#include "stdafx.h"
#include "mylab_d3d9.h"
#include "Game.h"								//嵌入CGame框架
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_MYLAB_D3D9, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_MYLAB_D3D9));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_MYLAB_D3D9));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+2);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_MYLAB_D3D9);
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   g_hWnd = CreateWindow(szWindowClass, szTitle, WS_OVERLAPPEDWINDOW,
      CW_USEDEFAULT, 0, CW_USEDEFAULT, 0, NULL, NULL, hInstance, NULL);//将窗口句柄存储在全局变量中
